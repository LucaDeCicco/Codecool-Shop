...
@WebServlet(name = "OrderByPriceServlet", urlPatterns = {"/api/orderByPrice"}, loadOnStartup = 1)
public class OrderByPriceApi extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<Product>filteredList = filterMem.orderByPrice(criteria);
